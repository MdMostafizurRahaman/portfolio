...
export default function HeroSection() {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      <div className="absolute inset-0 z-0 bg-gradient-to-br from-accent/5 via-primary/5 to-secondary/5"></div>
      ...
      <div className="container mx-auto px-4 md:px-8 grid md:grid-cols-5 gap-8 items-center z-10">
        <div className="md:col-span-3 space-y-8 order-2 md:order-1">
          ...
          <motion.p 
            className="text-gray-600 text-lg md:pr-16 leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <a 
              href="#projects" 
              className="bg-white border-2 border-primary text-primary hover:bg-primary/5 px-8 py-3 rounded-full font-medium transition-all"
              onClick={(e) => {
                e.preventDefault();
          ...
          >
            <a href="https://github.com/MdMostafizurRahaman" target="_blank" rel="noopener noreferrer" className="text-dark hover:text-primary transition-colors text-xl" aria-label="GitHub">
              <i className="fab fa-github"></i>
            </a>
            <a href="https://linkedin.com/in/md-mostafizur-rahaman" target="_blank" rel="noopener noreferrer" className="text-dark hover:text-primary transition-colors text-xl" aria-label="LinkedIn">
              <i className="fab fa-linkedin"></i>
            </a>
            <a href="mailto:bsse1320@iit.du.ac.bd" className="text-dark hover:text-primary transition-colors text-xl" aria-label="Email">
