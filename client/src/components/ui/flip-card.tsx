  ...
  return (
    <div className="flip-card h-full perspective-1000">
      <div className="flip-card-inner relative w-full h-full transition-transform duration-600 transform-style-preserve-3d hover:rotate-y-180">
        {/* Front Side */}
        <div className="flip-card-front absolute w-full h-full bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden backface-hidden">
        ...
        {/* Back Side */}
        <div className="flip-card-back absolute w-full h-full bg-white rounded-xl shadow-md border border-gray-100 p-6 backface-hidden rotate-y-180">
